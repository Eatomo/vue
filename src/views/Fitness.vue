<template>
  <div class="fitness-page">
    ...
    <!-- 健身食譜推薦區塊 -->
<div class="fitness-recipes-section">
  <div style="display: flex; align-items: center; justify-content: center; gap: 16px;">
    <h2 style="margin: 0;">健身飲食推薦食譜</h2>
    <button
      class="refresh-btn"
      @click="fetchFitnessRecipes"
...
export default {
  ...
  methods: {
    ...
    // 取得健身食譜
    async fetchFitnessRecipes() {
      this.loadingRecipes = true;
      this.recipesError = '';
      try {
        const res = await fetch('https://backage-2dtn.onrender.com/fitness-recipes');
