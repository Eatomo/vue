<template>
  <div class="children-page">
    ...
    <!-- 兒童食譜推薦區塊 -->
 <div class="children-recipes-section">
  <div style="display: flex; align-items: center; justify-content: center; gap: 16px;">
    <h2 style="margin: 0;">兒童飲食推薦食譜</h2>
    <button
      class="refresh-btn"
      @click="fetchChildrenRecipes"
...
export default {
  ...
  methods: {
    ...
    // 取得兒童食譜
    async fetchChildrenRecipes() {
      this.loadingRecipes = true;
      this.recipesError = '';
      try {
        const res = await fetch('https://backage-2dtn.onrender.com/children-recipes');
...
.children-page {
  min-height: 100vh;
  background: url('/src/assets/images/pexels-alexander-dummer-37646-1912868.jpg') no-repeat center center fixed;
