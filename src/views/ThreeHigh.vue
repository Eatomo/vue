<template>
  <div class="three-high-page">
    ...
    <!-- 頁面內容 -->
    <div class="three-high-container">
      <h1>3高專區</h1>
      <p>這是 3高（高血壓、高血糖、高血脂）飲食建議頁面。</p>
    </div>

    <!-- 三高食譜推薦區塊 -->
    <div class="high-recipes-section">
      <div style="display: flex; align-items: center; justify-content: center; gap: 16px;">
        <h2 style="margin: 0;">三高飲食推薦食譜</h2>
        <button
          class="refresh-btn"
          @click="fetchHighRecipes"
...
export default {
  ...
  methods: {
    ...
    async fetchHighRecipes() {
      this.loadingRecipes = true;
      this.recipesError = '';
      try {
        const res = await fetch('https://backage-2dtn.onrender.com/high-recipes');
...
.three-high-page {
  min-height: 100vh;
  background: url('/src/assets/images/pexels-artempodrez-6823737.jpg') no-repeat center center fixed;
  background-size: cover;
}
.three-high-container {
    max-width: 800px;
    margin: 50px auto;
    padding: 30px;
    background: #ffffffcc;
