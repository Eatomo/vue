<template>
  <div class="elderly-page">
    ...
    <!-- 銀髮族食譜推薦區塊 -->
<div class="elderly-recipes-section">
  <div style="display: flex; align-items: center; justify-content: center; gap: 16px;">
    <h2 style="margin: 0;">銀髮族飲食推薦食譜</h2>
    <button
      class="refresh-btn"
      @click="fetchElderlyRecipes"
...
export default {
  ...
  methods: {
    ...
    // 取得銀髮族食譜
    async fetchElderlyRecipes() {
      this.loadingRecipes = true;
      this.recipesError = '';
      try {
        const res = await fetch('https://backage-2dtn.onrender.com/senior-recipes');
...
.elderly-page {
  min-height: 100vh;
  background: url('/src/assets/images/pexels-elevate-3009797.jpg') no-repeat center center fixed;
