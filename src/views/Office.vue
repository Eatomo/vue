<template>
  <div class="office-page">
    ...
    <!-- 上班族食譜推薦區塊 -->
<div class="office-recipes-section">
  <div style="display: flex; align-items: center; justify-content: center; gap: 16px;">
    <h2 style="margin: 0;">上班族飲食推薦食譜</h2>
    <button
      class="refresh-btn"
      @click="fetchOfficeRecipes"
...
export default {
  ...
  methods: {
    ...
    // 取得上班族食譜
    async fetchOfficeRecipes() {
      this.loadingRecipes = true;
      this.recipesError = '';
      try {
        const res = await fetch('https://backage-2dtn.onrender.com/office-recipes');
...
.office-page {
  min-height: 100vh;
  background: url('/src/assets/images/pexels-fauxels-3184299.jpg') no-repeat center center fixed;
